...
| ------------------ | ------ | ------ | ------ | ------ | ------ |
| 训练前（默认权重） | 0.7011 | 0.7847 | 0.8251 | 0.8573 | 0.6970 |
| 训练后             | 0.9678 | 0.9914 | 0.9951 | 0.9974 | 0.9572 |
...
若原始视频文件过多过大，不建议将 videos 目录上传，可将其上传到网络，如对象存储，或使用 Alist，然后通过链接访问视频文件，video_path_root 环境变量设置为域名路径即可。
